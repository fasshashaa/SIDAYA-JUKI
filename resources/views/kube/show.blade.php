...
<div class="max-w-4xl mx-auto">
   ...
   <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Detail Kelompok Usaha Bersama</h1>
        <p class="text-sm text-gray-500 mt-1">Data Kelompok Usaha Bersama Kabupaten Cilacap.</p>
    </div>
