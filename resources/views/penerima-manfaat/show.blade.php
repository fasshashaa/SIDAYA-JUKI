...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6 flex justify-between items-center">
        <a href="{{ route('penerima-manfaat.index') }}" class="text-sm font-medium text-blue-600 hover:text-blue-700 hover:underline flex items-center gap-1.5 w-fit">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
            Kembali ke Daftar
        </a>
        <div class="inline-flex gap-2">
            <a href="{{ route('penerima-manfaat.edit', $penerima->id) }}" class="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-600 font-semibold px-4 py-2.5 rounded-xl text-sm border border-gray-200 transition-all">
    ...
    <div class="bg-white shadow-sm border border-gray-100 rounded-3xl overflow-hidden">
        ...
        {{-- Profile header --}}
        <div class="p-8 pb-6 border-b border-gray-50 bg-gradient-to-br from-gray-50/80 to-white flex items-center gap-5">
            <div class="w-16 h-16 rounded-2xl bg-blue-600 text-white flex items-center justify-center font-extrabold text-xl shrink-0 shadow-lg shadow-blue-600/20">
                {{ Str::of($penerima->nama_lengkap)->explode(' ')->map(fn($w) => Str::substr($w, 0, 1))->take(2)->implode('') }}
            </div>
            <div class="min-w-0">
                <h2 class="text-2xl font-extrabold text-gray-900 truncate">{{ $penerima->nama_lengkap }}</h2>
                @php
                    $statusStyles = [
                    ...
                    [$badgeClass, $dotClass] = $statusStyles[$penerima->status_verifikasi] ?? ['bg-gray-100 text-gray-600', 'bg-gray-400'];
                @endphp
                ...
                <div class="space-y-7">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-base text-gray-800 font-semibold mt-0.5">{{ $penerima->nama_ibu_kandung }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-base text-gray-800 font-semibold font-mono mt-0.5 tracking-wide">{{ $penerima->nik }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            @if($penerima->no_wa)
                                <a href="https://wa.me/{{ str_starts_with($penerima->no_wa, '0') ? '62'.substr($penerima->no_wa, 1) : $penerima->no_wa }}" target="_blank" class="text-base text-blue-600 font-semibold mt-0.5 inline-block hover:underline">{{ $penerima->no_wa }}</a>
                            @else
                                <p class="text-base text-gray-400 font-semibold mt-0.5">-</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-7">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-base text-gray-800 font-semibold font-mono mt-0.5 tracking-wide">{{ $penerima->no_kk }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-base text-gray-800 font-semibold mt-0.5">{{ $penerima->kecamatan }} <span class="text-gray-300 mx-1">/</span> {{ $penerima->desa }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-base text-gray-800 font-semibold mt-0.5">{{ $penerima->alamat_detail }}</p>
                        </div>
                    </div>
                </div>
            </div>
