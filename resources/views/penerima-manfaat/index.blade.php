...
<div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-5">
    ...
    <div class="flex items-center gap-2.5">
        ...
        <form action="{{ route('penerima-manfaat.import') }}" method="POST" enctype="multipart/form-data" class="hidden">
            @csrf
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" x-cloak
                ...
                <a href="{{ route('penerima-manfaat.export.excel') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors">
                ...
                <a href="{{ route('penerima-manfaat.export.pdf') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors">
                ...
                <a href="{{ route('penerima-manfaat.template') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors">
                        ...
                        <td class="p-4 relative">
                            <div x-data="{ open: false, dropUp: false }" x-on:click.away="open = false" class="relative inline-block text-left">
                                ...
                                <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" :class="dropUp ? 'bottom-full mb-2' : 'top-full mt-2'" class="absolute right-0 z-[100] w-40 bg-white rounded-xl shadow-xl shadow-slate-900/10 border border-slate-100 py-1.5">
                                    ...
                                    <a href="${this.routeEdit(item.id)}" class="flex items-center gap-2.5 px-4 py-2 text-sm text-amber-600 hover:bg-slate-50">
