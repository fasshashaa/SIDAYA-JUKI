                ...
                @if(Auth::user()->role === 'super_admin')
                    <div class="pt-3">
                        <div x-data="{ open: true }" class="rounded-xl" :class="!sidebarOpen && 'flex flex-col items-center'">
                            ...
                            <div class="group-panel w-full" :class="(open || !sidebarOpen) && 'is-open'">
                                <div class="space-y-1.5">
                                    <a href="{{ route('superadmin.users.index') }}" class="rail-item nav-item flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold {{ request()->routeIs('superadmin.users.*') ? 'active' : '' }}" :class="!sidebarOpen && 'justify-center px-0'">
