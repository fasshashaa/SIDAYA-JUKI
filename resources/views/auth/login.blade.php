...
<link rel="shortcut icon" type="image/png" href="{{ asset('img/Logo_sdy.png') }}">
    ...
    <style>
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .check-custom { width: 16px; height: 16px; border-radius: 5px; border: 1px solid rgba(255,255,255,0.25); background: rgba(255,255,255,0.04); accent-color: #0E7C9E; cursor: pointer; }
        ...
        .social-btn:hover { background: rgba(255,255,255,0.07); border-color: rgba(255,255,255,0.18); }
    </style>
</head>
            ...
            <form action="#" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <div class="input-wrap">
                        <span class="input-icon">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z" opacity="0"/><path d="M22 6l-10 7L2 6"/><rect x="2" y="4" width="20" height="16" rx="2"/></svg>
                        </span>
                ...
                <div class="mb-6">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="password" id="password" name="password" class="input-field input-field-icon w-full py-3.5 rounded-xl text-[14px] pr-12" placeholder="••••••••" required>
                        <button type="button" onclick="togglePassword()" class="absolute right-4 top-3.5 text-white/30 hover:text-white transition-colors">
                            <svg id="eye-icon" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                        </button>
                    </div>
                </div>
                ...
                <div class="mt-6 text-center text-[13px] text-white/40">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-[#5FD9E8] font-bold hover:underline ml-1">Daftar sekarang</a>
                </div>
            </form>
