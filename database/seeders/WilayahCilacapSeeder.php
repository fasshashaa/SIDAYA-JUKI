...
class WilayahCilacapSeeder extends Seeder
{
    public function run(): void
    {
        // 1. Kosongkan tabel agar tidak terjadi duplikasi data setiap kali seed dijalankan
        DB::table('wilayah_desas')->truncate();
        ...
        foreach ($data as $item) {
            // Gunakan $item[0] untuk kecamatan dan $item[1] untuk desa
